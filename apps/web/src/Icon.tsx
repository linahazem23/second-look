const PATHS: Record<string, string> = {
  ...
  community: '<circle cx="8" cy="9" r="3"/><circle cx="16" cy="9" r="3"/><path d="M2 20c0-3.3 2.7-5.5 6-5.5s6 2.2 6 5.5"/><path d="M10 20c0-2.6 1.8-4.5 4-4.5"/><path d="M14 20c0-3.3 2.7-5.5 6-5.5"/>'
};
...
export function categoryIcon(category: string) {
  ...
  if (category === 'MomBaby') return 'bottle';
  return 'dress';
}
